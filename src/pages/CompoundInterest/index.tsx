    ...
    <div className='flex flex-col lg:flex-row items-center justify-center min-h-screen bg-background p-4 lg:p-8 gap-8'>
      <div className='w-full lg:w-2/5 max-w-xl lg:max-w-none lg:-mt-16'>
        <div className='bg-primary/10 backdrop-blur-sm rounded-lg p-6 lg:p-8 shadow-lg '>
          ...
          <p className='text-lg text-foreground mb-6'>
            El interés compuesto es una herramienta financiera poderosa que
            puede trabajar a tu favor o en tu contra. En inversiones, multiplica
            tus ganancias con el tiempo. En deudas, puede aumentar
            significativamente lo que debes. Comprender y utilizar el interés
            compuesto es clave para tomar decisiones financieras inteligentes y
          ...
          <blockquote className='border-l-4 border-primary pl-4 italic text-lg text-foreground'>
            ...
            entiende, lo gana; quien no, lo paga."
            <footer className='text-sm mt-2 text-right'>
              — Warren Buffett
            </footer>
          </blockquote>
        </div>
      ...
      <Card className='w-full lg:w-1/2 max-w-md lg:mt-16 lg:ml-8'>
        <CardHeader>
          ...
          <CardDescription>
            Ingresa los datos para calcular el interés compuesto.
          </CardDescription>
        </CardHeader>
          ...
          {result > 0 && (
            <div className='text-center space-y-2'>
              ...
              <div>
                ...
                >
                  {Math.abs(profit).toLocaleString('es-ES', {
                    style: 'currency',
                    currency: 'EUR',
                  })}
                </p>
              ...
              <p className='text-sm text-muted-foreground'>
                {rate >= 0
                  ? `Crecimiento total: ${((profit / principal) * 100).toFixed(
                      2
                    )}%`
                  : `Decrecimiento total: ${(
                      (profit / principal) *
